...
\textbf{Limitation:} With only 200 training samples and 20 minutes of training, the training was not long enough to observe curriculum effects.
...
TritonRL achieves only 7\% correctness on kernel fusion tasks (Level 2), despite 63\% on basic operations (Level 1). This work implements four modular extensions targeting specific weaknesses: multi-input testing, staged evaluation, adaptive curriculum, and calibrated timing.

Training completed successfully: SFT loss decreased from 0.757 to 0.199 in 5 minutes, and RL training completed 2 fusion tasks in 15 minutes with final loss 0.17. Training used 200 samples (1.1\% of the 18K-sample dataset) for 20 minutes total, compared to likely hours of training at full scale for the baseline.
...
The author thanks the instructors and teaching staff for their guidance throughout this project, and colleagues who provided technical feedback on verification infrastructure design and RL training protocols.
